...
namespace SensorApp.API.Controllers
{
    ...
    public class SensorsController : ControllerBase
    {
        ...
        {
            var sensors = await _dbContext.Sensors.Select(x => new SensorModel(x.Id, x.Humidity, x.Light, x.Temperature)).ToListAsync();
        ...
        public async Task<ActionResult<SensorModel>> GetSensor(long id)
        {
            ...
            return Ok(new SensorModel(sensor.Id, sensor.Humidity, sensor.Light, sensor.Temperature));
        }
    }
}
